 ...
 * @cdk.githash
 */
public class DashedLineElement implements IRenderingElement {
     ...
     */
    public DashedLineElement(double firstPointX, double firstPointY, double secondPointX, double secondPointY, double width,
            Color color) {
