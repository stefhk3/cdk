 ...
 * @cdk.githash
 */
public class CircularArrowElement implements IRenderingElement {
     ...
     */
    public CircularArrowElement(double startX, double startY, double endX, double endY, double width, double centreX, double centreY,
            Color color) {
        this.endX = startX;
        this.endY = startY;
        this.startX = endX;
    ...
    public String toString() {
    	return startX+" "+endX+" "+startY+" "+endY+" "+centreX+" "+centreY; 
    }
}
